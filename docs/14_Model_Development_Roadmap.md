...
- **Measure, don't assume, the actual k-hop reach per target node type** (`06_Graph_Database_Design.md` §11) — this is what the depth prior in Step 4 will actually be justified by, not the planning table in `project_HADES.md` §3A.7.
